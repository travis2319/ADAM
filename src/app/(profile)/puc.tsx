...
const STORAGE_KEY = 'user_puc_image'
...
const PUC = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Upload PUC</Text>
      <Button title="Pick PUC Image" onPress={pickImage} />
...
const styles = StyleSheet.create({
  container: { padding: 20, alignItems: 'center', backgroundColor: '#F5F9FF' },
